    ...
    def insert_data(self, values):
        ...
        try:
            ...
            sensor_data = SensorData(
                ...
                EC2_SO2=float(values[14]) if len(values) > 14 else None,
                EC3_VOC=float(values[15]) if len(values) > 15 else None,
                ...
                MOX_Heat=float(values[29]) if len(values) > 29 else None,
                TGS2602=float(values[30]) if len(values) > 30 else None,
                HP0=float(values[31]) if len(values) > 31 else None,
                HP1=float(values[32]) if len(values) > 32 else None,
                HP2=float(values[33]) if len(values) > 33 else None,
                HP3=float(values[34]) if len(values) > 34 else None,
                Error=float(values[35]) if len(values) > 35 else None,
